	...
	public static void main(String[] args) {
		...
		if(carMake==1) {
			while(true) {
				...
				System.out.println("[3]:RS6");
				System.out.println("[4]:RS7");
				carModel=sc.nextInt();
				if(carModel>=5) {
					System.out.println("Input error, please enter the number again");
					continue;
				...
				while(true) {
					...
					System.out.println("[3]:M4");
					System.out.println("[4]:M5");
					carModel=sc.nextInt();
					if(carModel>=5) {
						System.out.println("Input error, please enter the number again");
						continue;
				...
				while(true) {
					...
					System.out.println("[1]: Honda Civic Type-R FK8");
					System.out.println("[2]: Honda Civic Type-R FD2");
					carModel=sc.nextInt();
					if(carModel>=3) {
						System.out.println("Input error, please enter the number again");
						continue;
				...
				while(true) {
					...
					System.out.println("[1]:GR Yaris");
					System.out.println("[2]:GR Supra");
					carModel=sc.nextInt();
					if(carModel>=3) {
						System.out.println("Input error, please enter the number again");
						continue;
